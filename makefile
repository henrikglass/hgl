...
test_math:
	gcc -I. -std=c17 -Wall -Wextra -Wpedantic -Wno-unused-variable -Werror -O3 -march=native $(SRCDIR)/test_math.c -o test_math -lm
	gcc -I. -std=c17 -Wall -Wextra -Wpedantic -Wno-unused-variable -Werror -O3 -DHGL_MATH_USE_SIMD -march=native $(SRCDIR)/test_math.c -o test_math_simd -lm
